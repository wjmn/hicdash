...
import argparse
from hicdash.generator import make_html_report_and_save
...
def main():
    ...
    parser.add_argument("--breaks", type=str, help="Filepath to hic_breakfinder breaks.bedpe from Arima-SV Pipeline.", default=None)
